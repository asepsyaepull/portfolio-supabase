  ...
  return (
    <div className="min-h-[70vh] bg-zinc-50 dark:bg-gray-950 relative flex items-center justify-center overflow-hidden px-4 transition-colors duration-300">
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        <span className="text-brand font-mono tracking-widest text-xs md:text-sm uppercase mb-6 transition-colors">
          / 404 — Page Not Found
        </span>
        <h1 className="text-5xl md:text-7xl font-black tracking-tighter text-zinc-900 dark:text-white leading-[0.95] uppercase mb-6 transition-colors">
          Lost in <span className="text-brand italic font-serif normal-case">&</span> Space.
        </h1>
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-brand text-white font-bold text-sm tracking-tighter hover:bg-brand-deep transition-colors shadow-brand"
        >
          BACK TO HOME
        </Link>
      </div>
