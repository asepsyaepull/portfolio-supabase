...
export const contactPageId: ContactPageDictionary = {
  ...
  socialHeading: "Jaringan Profesional",
  ...
  formCardTag: "02 message-composer.fig",
  fullNameLabel: "Nama Lengkap",
  emailAddressLabel: "Alamat Email",
  subjectLabel: "Subjek Pesan",
  messageLabel: "Detail Kebutuhan Proyek",
  ...
  scopeChips: [
    ...
    "Mobile App Design",
    "Konsultasi & Code Review",
  ],

  faqHeading: "Ekspektasi Kolaborasi",
  faqSubheading: "Pertanyaan yang sering diajukan sebelum kita memulai proyek bersama.",
  faqs: [
    {
